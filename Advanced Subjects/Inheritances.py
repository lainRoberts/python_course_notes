...
print(isinstance(wizard1,Wizard)) #parent class CHECKS IF wizard1 IS AN ISNTANCE OF Wizard
print(isinstance(wizard1,User)) #child class CHECKS IF wizard1 IS AN ISNTANCE OF User
print(isinstance(wizard1,object)) #type class CHECKS IF wizard1 IS AN ISNTANCE OF object
